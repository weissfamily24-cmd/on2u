...
// TODO: Screen aus prototype/index.html übertragen (siehe docs/screens.md, Zeile "profile").
export default function Screen() {
  return (
    <View style={s.root}><Text style={s.t}>profile</Text><Text style={s.sub}>Noch nicht gebaut. Referenz: prototype/index.html</Text></View>
  );
}
