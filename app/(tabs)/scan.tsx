...
// TODO: Screen aus prototype/index.html übertragen (siehe docs/screens.md, Zeile "scan").
export default function Screen() {
  return (
    <View style={s.root}><Text style={s.t}>scan</Text><Text style={s.sub}>Noch nicht gebaut. Referenz: prototype/index.html</Text></View>
  );
}
